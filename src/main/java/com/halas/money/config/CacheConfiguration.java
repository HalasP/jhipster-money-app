package com.halas.money.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.halas.money.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.halas.money.repository.UserRepository.USERS_BY_EMAIL_CACHE);
